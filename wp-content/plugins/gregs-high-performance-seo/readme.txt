...
* Added support for the wp_get_document_title() function introduced in WordPress 4.4; now that the title tag functionality first introduced in WordPress 4.1 can be filtered by plugins, GHPSEO will automatically work with themes that have enabled support for WordPress-generated title tags.
