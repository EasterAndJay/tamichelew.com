...
function solostream_post_meta_boxes() {
	...
	$meta_boxes = array(
		...
		"post_featpages" => array(
			"name" => "post_featpages",
			"type" => "select",
			"title" => __("Add Featured Content/Email Capture Form to This Post", "solostream"),
			"description" => __("Select Yes to add the Featured Content/Email Capture Form to the top of this Post.", "solostream"),
			"options" => array(
					"No", 
					"Yes")),
...
function solostream_page_meta_boxes() {
	...
	$meta_boxes = array(
		...
		"post_featpages" => array(
			"name" => "post_featpages",
			"type" => "select",
			"title" => __("Add Featured Content/Email Capture Form to This Page", "solostream"),
			"description" => __("Select Yes to add the Featured Content/Email Capture Form to the top of this Page.", "solostream"),
			"options" => array(
					"No", 
					"Yes")),
