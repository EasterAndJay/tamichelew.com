...
// Featured Pages
	...
	$options[] = array(
			"name" => __("Featured Content / Email Capture Form", "solostream"),
			"id" => $shortname."_featured_pages",
			"type" => "header");

	$options[] = array(
			"name" => __("Add Featured Content / Email Capture Slider to Home Page", "solostream"),
			"id" => $shortname."_featpage_on",
			"type" => "select",
			"std" => "No",
			"options" => array("No", "Yes"),
			"help" => __("Select Yes to add the Featured Content / Email Capture form to the home page.", "solostream"));

	$options[] = array(
			"name" => __("Activate Auto-Scrolling", "solostream"),
			"id" => $shortname."_feat_autoscroll",
			"type" => "select",
			"std" => "No",
			"options" => array("No", "Yes"),
			"help" => __("Select Yes to activate Feautred Content auto-scrolling.", "solostream"));

	$options[] = array(
			"name" => __("Auto-Scroll Speed", "solostream"),
			"id" => $shortname."_feat_scrollspeed",
			"type" => "text",
			"std" => "7000",
			"help" => __("Enter the speed for the auto-scroll. 7000 = 7 seconds per slide.", "solostream"));

	$options[] = array(
			"name" => __("Which Pages/Posts to Feature", "solostream"),
			"id" => $shortname."_featpage_ids",
			"type" => "text",
			"std" => "",
			"help" => __("Leave blank for Email Capture Form only. Otherwise, enter a comma-separated list of the <a rel='external' title='How to Find a WordPress Page ID' href='http://en.support.wordpress.com/pages/#how-to-find-the-page-id'>page/post ID's</a> to display in the slider (e.g. 1,2,3,4). <span style='color:#cc0000;'>Note: List page/post IDs in the order you'd like them to appear in the slider.</span>", "solostream"));

	$options[] = array(
			"name" => __("Add Video Email Capture as First Slide", "solostream"),
			"id" => $shortname."_videmailform_on",
			"type" => "select",
			"std" => "No",
			"options" => array("No", "Yes"),
			"help" => __("Select Yes to add the Video Email Capture Form as the first slide, then complete the information below.", "solostream"));

	$options[] = array(
			"name" => __("Video Embed Code for Video Email Capture Form", "solostream"),
			"id" => $shortname."_videmailform_embed_code",
			"type" => "textarea",
			"std" => "",
			"help" => __("Enter the video embed code for your video. You can get the video embed code from your video hosting service provider (e.g. Youtube, Vimeo, etc.", "solostream"));

	$options[] = array(
			"name" => __("Video Email Capture Form Title", "solostream"),
			"id" => $shortname."_videmailform_title",
			"type" => "textarea",
			"std" => "",
			"help" => __("Enter the title for your Video Email Capture form (e.g. Subscribe to my Email List.).", "solostream"));

	$options[] = array(
			"name" => __("Video Email Capture Form Copy", "solostream"),
			"id" => $shortname."_videmailform_copy",
			"type" => "textarea",
			"std" => "",
			"help" => __("Enter the copy for your Video Email Capture form (e.g. Enter your name and email address below to sign up for my email list.).", "solostream"));

	$options[] = array(
			"name" => __("Video Email Capture Form Code", "solostream"),
			"id" => $shortname."_videmailform_code",
			"type" => "textarea",
			"std" => "",
			"help" => __("Enter the code for your Video Email Capture Form.", "solostream"));

	$options[] = array(
			"name" => __("Add Standard Email Capture as First Slide", "solostream"),
			"id" => $shortname."_emailform_on",
			"type" => "select",
			"std" => "No",
			"options" => array("No", "Yes"),
			"help" => __("Select Yes to add an Standard Email Capture Form as the first slide, then complete the information below.", "solostream"));

	$options[] = array(
			"name" => __("Standard Email Capture Slide Title/Headline", "solostream"),
			"id" => $shortname."_emailslide_title",
			"type" => "textarea",
			"std" => "",
			"help" => __("Enter a title for the Standard Email Capture slide.", "solostream"));

	$options[] = array(
			"name" => __("Standard Email Capture Slide Copy", "solostream"),
			"id" => $shortname."_emailslide_copy",
			"type" => "textarea",
			"std" => "",
			"help" => __("Enter the copy for the Standard Email Capture slide.", "solostream"));

	$options[] = array(
			"name" => __("Standard Email Capture Form Title", "solostream"),
			"id" => $shortname."_emailform_title",
			"type" => "textarea",
			"std" => "",
			"help" => __("Optional: Enter a title for your Standard Email Capture form (e.g. Subscribe to my Email List.).", "solostream"));

	$options[] = array(
			"name" => __("Standard Email Capture Form Copy", "solostream"),
			"id" => $shortname."_emailform_copy",
			"type" => "textarea",
			"std" => "",
			"help" => __("Optional: Enter the copy for your Standard Email Capture form (e.g. Enter your name and email address below to sign up for my email list.).", "solostream"));

	$options[] = array(
			"name" => __("Standard Email Capture Form Code", "solostream"),
			"id" => $shortname."_emailform_code",
			"type" => "textarea",
			"std" => "",
			"help" => __("Enter the code for your Standard Email Capture Form.", "solostream"));
...
// Basic Style Settings
	...
	$options[] = array(
			"name" => __("Site Width", "solostream"),
			"id" => $shortname."_sitewidth",
			"type" => "text",
			"std" => "",
			"help" => __("The default site width is 1180px. If you'd like to change it, enter the new value below. Example: 1040px.", "solostream"));
	...
	$options[] = array(
			...
			"type" => "select",
			"options" => array("Yes","No"),
			"help" => __("Select No to de-activate the box-shadow effect around your page. Note: This will only display on CSS3-compliant browsers.", "solostream"));
...
// Top Nav Style Settings
	...
	$options[] = array(
			...
			"id" => $shortname."_icons_topnav",
			"type" => "select",
			"std" => "Yes",
			"options" => array("Yes", "No"),
			"help" => __("Select No to remove the Social Media Icons from top navigation bar.", "solostream"));
...
// Button Colors
	...
	$options[] = array(
			...
			"type" => "text-color",
			"std" => "",
			"help" => __("Select a background color for the search submit, email submit and comments submit buttons. Leave blank to use default color. Click on field to show color picker.", "solostream"));
	...
	$options[] = array(
			...
			"type" => "text-color",
			"std" => "",
			"help" => __("Select a font color for the search submit, email submit and comments submit buttons. Leave blank to use default color. Click on field to show color picker.", "solostream"));
	...
	$options[] = array(
			...
			"type" => "text-color",
			"std" => "",
			"help" => __("Select a hover background color for the search submit, email submit and comments submit buttons. Leave blank to use default color. Click on field to show color picker.", "solostream"));
	...
	$options[] = array(
			...
			"type" => "text-color",
			"std" => "",
			"help" => __("Select a hover font color for the search submit, email submit and comments submit buttons. Leave blank to use default color. Click on field to show color picker.", "solostream"));
...
<?php } elseif ($value['type'] == "textarea") { ?>
		...
		<div class="field">
			<textarea name="<?php echo $value['id']; ?>" id="<?php echo $value['id']; ?>" rows="10" cols="90"><?php if ( get_option( $value['id'] ) != "") { echo stripslashes(get_option( $value['id'] ) ); } else { echo stripslashes($value['std'] ); } ?></textarea>
		</div>
