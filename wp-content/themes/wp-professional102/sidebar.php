<?php
	...
	if ( $solostream_options['solostream_layout'] !== "Full-Width" && $solostream_options['solostream_layout'] !== "Sidebar-Narrow | Content" && $solostream_options['solostream_layout'] !== "Content | Sidebar-Narrow" ) {
?>
